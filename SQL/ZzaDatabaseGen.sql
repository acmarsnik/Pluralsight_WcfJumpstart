...
/****** Object:  Database [Zza]    Script Date: 22.10.2019 10:35:53 ******/
CREATE DATABASE [Zza]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Zza', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Zza.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Zza_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Zza_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Zza].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [Zza] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [Zza] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [Zza] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [Zza] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [Zza] SET ARITHABORT OFF 
GO

ALTER DATABASE [Zza] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [Zza] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [Zza] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [Zza] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [Zza] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [Zza] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [Zza] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [Zza] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [Zza] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [Zza] SET  DISABLE_BROKER 
GO

ALTER DATABASE [Zza] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [Zza] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [Zza] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [Zza] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [Zza] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [Zza] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [Zza] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [Zza] SET RECOVERY FULL 
GO

ALTER DATABASE [Zza] SET  MULTI_USER 
GO

ALTER DATABASE [Zza] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [Zza] SET DB_CHAINING OFF 
GO

ALTER DATABASE [Zza] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [Zza] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [Zza] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [Zza] SET  READ_WRITE 
GO
